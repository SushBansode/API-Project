...
class Student extends REST_Controller{
  ...
  */
  ...
  // PUT: <project_url>/index.php/api/student
  ...
  // // DELETE: <project_url>/index.php/api/student
...
public function index_delete() {
  ...
  // Assuming delete_student returns true on success and false on failure
  if ($this->student_model->delete_student($student_id)) {
      ...
      if ($affected_rows > 0) {
          ...
          // No rows affected, consider it a failure
          $this->response(array(
              "status" => 0,
              "message" => "Failed to delete student"
          ), REST_Controller::HTTP_NOT_FOUND);
